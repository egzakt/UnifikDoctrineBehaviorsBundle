...
namespace Egzakt\DoctrineBehaviorsBundle\Model\Repository;
...
trait TranslatableEntityRepository
{
    ...
    {
        return $this->getContainer()->get('egzakt_system.core');
    }
     ...
     *
     * Exemple: Converts Egzakt\Backend\SectionBundle\Section to EgzaktBackendSectionBundle:Section
     *
